...
export default function HomePage() {
  return (
    <div className="container mx-auto">
      ...
      {/* コンテンツセクション */}
      <section className="grid grid-cols-1 gap-8 px-24 py-16">
        {/* 自己紹介 */}
        <div className="flex flex-col md:flex-row md:space-x-12 space-y-4 md:space-y-0">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p>出身校</p>
            <ul>
              <li>小学校:鹿角市立十和田小学校 卒業</li>
              <li>中学校:鹿角市立十和田中学校 卒業</li>
              <li>高校:秋田県立大館桂桜高等学校 卒業</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:space-x-12 space-y-4 md:space-y-0">
          <div className="w-full md:w-1/2">
            ...
            <p>
              私は主にバックエンド開発を得意としており、特にLaravelを用いた開発に多くの経験があります。
            </p>
            <p>
              また、フルスタックエンジニアを目指しており、バックエンド以外にも幅広い技術の習得に取り組んでいます。
            </p>
            <p>
          ...
          <Image src="/11.png" alt="Placeholder" width={400} height={300} />
        </div>

        {/* メッセージ */}
        <div className="flex flex-col md:flex-row md:space-x-12 space-y-4 md:space-y-0">
          <Image src="/12.png" alt="Placeholder" width={400} height={300} />
          <div className="w-full md:w-1/2">
            <h2 className="text-xl font-bold mb-2">メッセージ</h2>
            <p>
              これまで支えてくださったすべての方々に、心から感謝申し上げます。
            </p>
            <p>
              多くの人々との出会いや経験を通じて成長を実感し、それが私の挑戦を支える原動力となっています。
            </p>
            <p>
              将来的には、社会課題の解決に寄与するプロジェクトに携わりたいと考えています。私はこれまで、多くの方々に助けられながら成長してきました。その経験から、自分も知識や経験を積み重ねることで、周囲の人や社会に貢献できる存在になりたいと思っています。
            </p>
            <p>
              ITの力を活用し、システムやアプリケーションを通じて、多くの人々に価値ある体験を提供することで、社会に良い影響を与えたいと考えています。
            </p>
            <p>
